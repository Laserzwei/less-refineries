...
function SectorTemplate.generate(player, seed, x, y)
    ...
    local resourcetrader = generator:createStation(faction, "data/scripts/entity/merchants/resourcetrader.lua");
    resourcetrader:addScriptOnce("data/scripts/entity/merchants/refinery.lua")
